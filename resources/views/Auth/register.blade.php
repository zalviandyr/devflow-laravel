  ...
  <div class="flex h-screen">
    ...
    <div class="flex items-center w-1/2">
      <div class="block w-full text-center">
        <h4 class="text-3xl text-red-400">Register <span class="font-bold text-red-500">Dev</span><span
            class="italic">Flow</span></h4>
        <form class="mx-auto mt-10 text-left w-96">
          ...
          <div class="relative my-6">
            <input type="text" id="name"
              ...
              placeholder=" " />
            <label for="name"
              class="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-white px-2 peer-focus:px-2 peer-focus:text-red-600 peer-focus:dark:text-red-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1">Nama
              Lengkap</label>
          </div>
          <div class="relative my-6">
          ...
          <button type="submit"
            class="block px-2.5 pb-2.5 pt-4 w-full bg-red-500 text-white rounded-lg hover:bg-red-400">
            Register
          </button>
        </form>
      </div>
