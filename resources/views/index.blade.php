...
@section('title', 'Home')
@section('content')
  <img src="{{ asset('images/community.png') }}" <div
    class="relative flex justify-center min-h-screen py-4 bg-gray-100 items-top sm:items-center sm:pt-0">
  ...
  <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
    ...
    <div class="mt-8 bg-white shadow dark:bg-gray-800 sm:rounded-lg">
