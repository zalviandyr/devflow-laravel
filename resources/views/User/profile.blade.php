...
@section('content')
  <div class="container p-3">
    ...
    <form action="{{ route('profile.update') }}" method="POST" class="p-10 bg-white shadow-md rounded-xl">
      ...
      <div class="flex justify-between">
        <div class="relative w-1/3">
          <div class="group w-60">
            <img src="{{ asset('images/avatar.svg') }}" class="rounded-full w-60 h-60" id="imgOut" />
      ...
      <button type="submit"
        class="w-full py-2 mt-6 font-semibold text-center text-white bg-red-500 rounded-lg hover:bg-red-600">
