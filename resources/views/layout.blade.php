              ...
              <div class="relative flex items-center h-16 space-x-2 group">
                ...
                <div
                  ...
                  <a href="{{ route('profile') }}"
                    class="px-4 py-4 text-md text-slate-500 dark:text-gray-500 hover:bg-slate-200 hover:text-blue-500">
                    Profile
                  </a>
                  <a href="#"
                    class="px-4 py-4 text-md text-slate-500 dark:text-gray-500 hover:bg-slate-200 hover:text-blue-500">
      ...
      <div class="sticky w-full top-20">
        ...
        @foreach ($categories as $categori)
          <div class="text-start">
            <a href="{{ route('category.detail', ['slug' => $categori->slug]) }}"
              class="flex items-center pl-4 hover:bg-red-50">
